function updateCountdown() {
    ...
    var targetTime = new Date("January 1, 2024 00:00:00");
    ...
    if (timeDifference > 0) {
       ...
       // document.getElementById("happyNewYear2").style.display = "none";
...
function launchFireworks() {
    setInterval(createFirework, 500); // create a firework every 0.5s
}
